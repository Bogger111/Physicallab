...
report generation updates the same session and increments its revision. This
version does not crop cells, perform OCR, train a model, identify users, or
store request IP addresses, headers, browser fingerprints, or account data.
